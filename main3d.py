...
def main():
    ...
    def update(frame):
        ...
        x_1,y_1,x_2,y_2,z_1,z_2  = plotAngle(jointAngles)
        err = np.array([target[0] - x_2, target[1] - y_2, target[2] - z_2])
        ...
        arm.set_data3d([0,x_3, x_4], [0,y_3,y_4], [0,z_3,z_4]) 
